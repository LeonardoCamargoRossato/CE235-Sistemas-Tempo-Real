    ...
    <section className="institutional-hero institutional-hero--compact">
      ...
      <div className="container institutional-hero__content">
        <div>
          ...
          <p>Documentação acadêmica das atividades desenvolvidas na CE-235 — Sistemas Embarcados de Tempo Real, incluindo laboratórios com ANSYS SCADE e a participação no Projeto Acadêmico SPRB-TR/BD.</p>
          <a className="button button--gold hero-drive" href={links.disciplineDrive} target="_blank" rel="noopener noreferrer">
